                    ...
                    >
                        ...
                        >
                            <div className='flex flex-col gap-2'>
                                ...
                                <div
                                    id='linear_equation'
                                    className='flex flex-row justify-between w-full px-3 py-1 rounded-md border-1 bg-neutral-100 border-neutral-200 dark:bg-neutral-900 dark:border-neutral-700'
                                >
                                    <span className='font-mono text-neutral-800 dark:text-neutral-400'>
                                        y = m · x + b
                                    </span>{' '}
                                    <SquareFunction className='text-neutral-500 dark:text-neutral-500' />
                                </div>
                            </div>
