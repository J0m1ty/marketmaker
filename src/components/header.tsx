        ...
        <div className="px-1 w-full border-b-1 border-dashed flex flex-row justify-between relative">
            ...
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center">
                <span className="font-bold translate-y-[1px]">
                    {
                        location.pathname === "/"
                            ? <span className="text-lg">Market Explorer</span>
                            : location.pathname === "/create"
                                ? <span className="text-lg">Market Builder</span>
                                : <span className="text-lg">Learn</span>
                    }
                </span>
            </div>
            <div className="flex flex-row items-center p-2 gap-3">
                <Button variant="outline" size="icon" onClick={() => window.open("https://github.com/J0m1ty/marketmaker", "_blank")}>
