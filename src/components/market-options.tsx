                ...
                return (
                    <div className='flex flex-col gap-1'>
                        ...
                        <Input
                            id='quantity_input'
                            value={
                                editingOption && quantity === 0 ? '' : quantity
                            }
                            onChange={(e) => {
                                const value = parseFloat(e.currentTarget.value);
                        ...
                        <div className='flex flex-row gap-2 items-center'>
                            ...
                            <Input
                                ...
                                value={
                                    (
                                        activeInput === 1 &&
                                        activeTab.bounds.quantityMin === 0
                                    ) ?
                                        ''
                            ...
                            <Input
                                ...
                                value={
                                    (
                                        activeInput === 2 &&
                                        activeTab.bounds.quantityMax === 0
                                    ) ?
                                        ''
                                    :   activeTab.bounds.quantityMax
                                }
                ...
                <CardContent className='px-2 sm:px-6 flex flex-col gap-2 h-full'>
                    <Select
                        ...
                        onValueChange={(value) => {
                            setAdjustmentMode(
                                activeTab.market.id,
                                value as (typeof AdjustmentModes)[number]
                            );
                        }}
                    >
                        ...
                        <SelectContent>
                            {Object.entries(groupedAdjustments).map(
                                ([type, modes]) => (
            ...
            <Card className='gap-1 flex-1 dark:bg-neutral-900'>
                ...
                <CardContent className='px-2 sm:px-6'>
                    <div className='flex flex-col gap-2'>
                        ...
                        <Select
                            value={
                                activeTab.curves[activeTab.curves.selected].fit
                            }
                            onValueChange={(value) => {
                                updateCurveFit(
                                    activeTab.market.id,
                        ...
                        <ColorSelect
                            ...
                            hex={
                                activeTab.curves[activeTab.curves.selected]
                                    .color
                            }
                            setHex={(hex) => {
